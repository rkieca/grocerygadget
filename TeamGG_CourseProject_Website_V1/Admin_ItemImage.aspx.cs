...
{
    public partial class Admin_ItemImage : System.Web.UI.Page
    {
            ...
            foreach (GridViewRow gr in GridView1.Rows)
            {
                ...
                if (rb.Checked == true)
                {
                    ...
                    if (FileUpload1.HasFile)
                    {
                        ...
                        {
                            MessageBox("Please upload an image with extensions of jpg, png, tif, or bmp. Other extensions are not accepted.");
                        }
                        else
                        {
                            ...
                            {
                                string pathName = "images/items/" + Path.GetFileName(FileUpload1.PostedFile.FileName);
                                ...
                                try
                                {
                                    ...
                                    strSQL = ("Update ITEM set Item_ImgPath = '" + pathName + "' WHERE Item_Id = " + GridView1.DataKeys[gr.DataItemIndex].Values["Item_Id"].ToString() + "");
                                    ...
                                    conn.Close();
                                    FileUpload1.SaveAs(Server.MapPath("~/images/items/" + FileUpload1.FileName));
